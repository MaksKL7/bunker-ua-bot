...
CATASTROPHES = [
    ...
    "🔥 Світова пожежа: 80 відсотків лісів згоріло, атмосфера отруєна.",
    "🧊 Глобальне похолодання: середня температура впала на 10 градусів.",
    "🦠 Супербактерія: невиліковна хвороба вбила половину населення.",
    "⚡ Електромагнітна буря: всі пристрої знищені, світ повернувся в кам'яний вік.",
    ...
    "🧬 Генетична катастрофа: експеримент призвів до мутації людей і тварин."
]
